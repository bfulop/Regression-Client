...
},{"hyperapp":"node_modules/hyperapp/src/index.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"_css_loader":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"utils.js":[function(require,module,exports) {
"use strict";
...
var socket = (0, _socket2.default)('http://localhost:3033');
socket.on('connect', function () {
...
var randomNum = R.compose(Math.round, R.multiply(100000), Math.random);
...
var renderResults = function renderResults(r) {
  return function (t) {
    ...
    return (0, _html.div)({ className: 'target' }, [(0, _html.h1)(R.compose(R.defaultTo('index'), R.prop('route'))(t)), R.compose(R.map(renderBreakpoint), R.prop('targets'))(t)]);
  };
};
...
},{"hyperapp":"node_modules/hyperapp/src/index.js","@hyperapp/html":"node_modules/@hyperapp/html/dist/html.js","./main.css":"main.css","./utils":"utils.js","socket.io-client":"node_modules/socket.io-client/lib/index.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
